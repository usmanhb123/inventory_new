    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="app?page=home" class="b-brand text-primary">
                    <!-- ========   Change your logo from here   ============ -->
                    <img alt="" class="logo logo-lg" />
                </a>
            </div>
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="app?page=home" class="pc-link"><span class="pc-micon"><i class="ti ti-home"></i></span><span class="pc-mtext">Home</span></a>
                    </li>
                    <li class="pc-item">
                        <a href="app?page=kategori" class="pc-link"><span class="pc-micon"><i class="ti ti-box"></i></span><span class="pc-mtext">Kategori</span></a>
                    </li>
                    <li class="pc-item">
                        <a href="app?page=ruangan" class="pc-link"><span class="pc-micon"><i class="ti ti-building"></i></span><span class="pc-mtext">Ruangan</span></a>
                    </li>
                    <li class="pc-item">
                        <a href="app?page=users" class="pc-link"><span class="pc-micon"><i class="ti ti-users"></i></span><span class="pc-mtext">Users</span></a>
                    </li>
                    <li class="pc-item">
                        <a href="app?page=barang" class="pc-link"><span class="pc-micon"><i class="ti ti-box"></i></span><span class="pc-mtext">Barang</span></a>
                    </li>
